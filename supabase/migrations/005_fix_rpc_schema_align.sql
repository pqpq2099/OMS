-- =============================================================================
-- 005_fix_rpc_schema_align.sql  —  對齊實際 DB schema
-- 建立時間: 2026-03-30
-- 說明:
--   003/004 的 INSERT 欄位清單與實際 table schema 不符：
--     stocktakes:           無 stocktake_type 欄位
--     stocktake_lines:      無 qty / unit_id / base_unit / created_by / updated_by
--     purchase_order_lines: 無 base_unit / created_by / updated_by
--   此 migration 以 CREATE OR REPLACE 修正 function，使欄位清單與實際 schema 一致。
-- =============================================================================
...
BEGIN
    -- 1. Upsert stocktake
    -- stocktakes 實際欄位: stocktake_id, store_id, stocktake_date, vendor_id,
    ...
    -- stocktake_lines 實際欄位: id(auto), stocktake_line_id, stocktake_id, store_id, vendor_id,
    --                            item_id, item_name, stock_qty, stock_unit_id, stock_unit, base_qty,
    --                            suggested_order_qty, order_qty, order_unit_id, note, created_at, updated_at
    ...
    -- purchase_orders 實際欄位: po_id, po_date, order_date, expected_date, delivery_date,
    --                            store_id, vendor_id, status, note, created_at, created_by, updated_at, updated_by
    ...
    -- purchase_order_lines 實際欄位: id(auto), po_line_id, po_id, store_id, vendor_id,
    --                                 item_id, spec_id, item_name, qty, order_qty, unit_id, order_unit,
    --                                 base_qty, unit_price, amount, note, delivery_date, created_at, updated_at
    ...
    -- audit_logs 實際欄位: audit_id, ts, user_id, action, table_name, entity_id, before_json, after_json, note
