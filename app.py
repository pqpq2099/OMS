...
st.markdown("""
    ...
    /* 2. 徹底消滅輸入框幽靈文字與重疊：僅針對 text_input */
    ...
    with st.form("inventory_form"):
        ...
        for _, row in items.iterrows():
            ...
            with c1:
                ...
                last_item_name = d_n
            # 💡 終極修復：text_input 配合 label_visibility="collapsed"
...
# 其他報表邏輯 (analysis, export) 完整保留，不作變動
