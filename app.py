...
st.markdown("""
    ...
    .stCaption { font-weight: 700 !important; font-size: 13px !important; color: #555 !important; }
    </style>
    ...
    with st.form("inventory_form"):
        ...
        for _, row in items.iterrows():
            ...
            with c1:
                ...
                # 💡 只保留核心：上次叫貨紀錄
                st.caption(f"(前結: {int(p_s+p_p)})")
                last_item_name = d_n
            # 💡 終極方案：強制隱藏標籤並拔除 +- 按鈕，確保單排且無重疊文字
